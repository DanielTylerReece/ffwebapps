...
fn main() {
    ...
    generate_to(Shell::Bash, &mut app, "ffwebapps", &completions).unwrap();
    generate_to(Shell::Elvish, &mut app, "ffwebapps", &completions).unwrap();
    generate_to(Shell::Fish, &mut app, "ffwebapps", &completions).unwrap();
    generate_to(Shell::PowerShell, &mut app, "ffwebapps", &completions).unwrap();
    generate_to(Shell::Zsh, &mut app, "ffwebapps", &completions).unwrap();
